...
to the score.  [The details for editing the file are here.](https://github.com/currawong-project/cmtools/blob/master/doc/xscore_gen.md).
...
[READ MORE](https://github.com/currawong-project/cmtools/blob/master/doc/xscore_gen.md)
